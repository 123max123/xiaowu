...
<body>
<div class="boxinfo">
	<div class="alert alert-error0">
		<a href="javascript:history.back(-1);" class="close">x</a>
		<strong>跳转提示：</strong> __INFO__
	</div>	
	<p class="meta"><a href="javascript:history.back(-1);" class="more">返回</a></p> 
	<p class="copyright">&copy; <a href="http://www.113344.com" target="_blank">__WPHP__</a></p> 
</div>
</body>
</html>
...
<div class="gbook-header cl">
	<span class="z"><a href="#gookform" class="btn btn-primary">我要留言</a>&nbsp;&nbsp;&nbsp;&nbsp;共有留言 <?php echo $ptotal; ?> 条</span>
...
<?php echo $phtml; ?>
  ...
  <h1>在线留言<span><?php echo C('gbook_about'); ?></span></h1>
  ...
  <input type="hidden" name="bid" value="<?php echo $bid; ?>"/> 
	 ...
	 <div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" name="name" id="name" placeholder="请输入留言昵称"/>
	    </div>
	  </div>	 
	 <div class="form-group">
	  ...
	  <?php }?>	  
	  <div class="form-group">
	    <label for="pcontent" class="col-sm-2 control-label">留言</label>
	    <div class="col-sm-10">
	    	<textarea class="form-control" name="pcontent" id="pcontent" rows="3" placeholder="请输入留言内容"></textarea>
	    </div>
	  </div>
	 <div class="form-group">
